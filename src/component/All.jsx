...
const All = () => {
    ...
    return (
        <div>
            <Fade>
            <h2 className="text-2xl font-semibold mb-4 text-center mt-10">All Items</h2>
            <table className="table-auto mx-auto border-collapse border border-gray-500">
                <thead>
                    <tr>
                        <th className="border border-gray-500 px-4 py-2">Item Name</th>
                        <th className="border border-gray-500 px-4 py-2">Short Description</th>
                ...
                <tbody>
                    {items.map(item => (
                        <tr key={item._id} className="border border-gray-500">
                            <td className="border border-gray-500 px-4 py-2">{item.item_name}</td>
                            <td className="border border-gray-500 px-4 py-2">{item.short_description}</td>
                            <td className="border border-gray-500 px-4 py-2">{item.price}</td>
                            <td className="border border-gray-500 px-4 py-2">
                                <Link to={`/view/${item._id}`} className="text-blue-600 hover:underline">View Details</Link>
                            </td>
                        </tr>
                    ))}
                </tbody>
